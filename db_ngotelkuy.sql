...
CREATE TABLE `tb_akomodasi` (
  `id_akomodasi` int(11) UNSIGNED NOT NULL,
  `id_kecamatan` int(11) NOT NULL,
  `nama_akomodasi` varchar(256) NOT NULL,
  `id_tipeAkomodasi` int(11) NOT NULL,
  `alamat_lengkap` varchar(256) NOT NULL,
...
CREATE TABLE `tb_akun` (
  ...
  `foto` varchar(50) DEFAULT 'default.jpeg',
...
INSERT INTO `tb_akun` (`id_akun`, `nama`, `email`, `password`, `foto`, `role_id`, `created_at`, `updated_at`) VALUES
...
CREATE TABLE `tb_fasilitas` (
  `id_fasilitas` int(11) UNSIGNED NOT NULL,
  `id_akomodasi` int(11) NOT NULL,
  `nama_fasilitas` varchar(256) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
CREATE TABLE `tb_tamu` (
  `id_tamu` int(11) UNSIGNED NOT NULL,
  `nama` varchar(50) DEFAULT NULL,
  `email` varchar(50) DEFAULT NULL,
  `alamat` varchar(256) DEFAULT NULL,
  `no_telp` int(20) DEFAULT NULL,
  `j_kelamin` varchar(11) DEFAULT NULL,
  `tempat_lahir` varchar(11) DEFAULT NULL,
...
--
-- Table structure for table `tb_tipeAkomodasi`
--
...
--
-- Indexes for table `tb_tipeAkomodasi`
--
...
--
ALTER TABLE `tb_fasilitas`
  MODIFY `id_fasilitas` int(11) UNSIGNED NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `tb_tamu`
  MODIFY `id_tamu` int(11) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `tb_tipeAkomodasi`
--
ALTER TABLE `tb_tipeAkomodasi`
